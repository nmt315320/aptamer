...
class Attention_2(Layer):
    ...
    def __init__(self,hidden_1,init_1='glorot_uniform',activation_1='linear',W_regularizer_1=None,W0_regularizer=None,W_constraint=None,W0_constraint=None,**kwargs):
        self.W_initializer = initializers.get(init_1)
        self.activation = activations.get(activation_1)
        self.W_regularizer = regularizers.get(W_regularizer_1)
        self.W0_regularizer = regularizers.get(W0_regularizer)
        self.W_constraint = constraints.get(W_constraint)
        self.W0_constraint = constraints.get(W0_constraint)
        self.hidden=hidden_1
